...
const TEMPLATE_VARIABLES = [
  ...
  { name: 'value', description: 'Contract value with currency (e.g., "THB 21,000.00")' },
  { name: 'value_amount', description: 'Contract value number only (no currency symbol)' },
  ...
  { name: 'rate_per_zone', description: 'Annual rate per zone with currency (value / zones)' },
  // Signatories
