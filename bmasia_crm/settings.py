...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',
    'mcp_server',  # Bug in v0.5.7 patched via crm_app.apps.CrmAppConfig.ready()
...
COMMERCIAL_DOCUMENT_V2_CONTRACT_LIVE = config(
    'COMMERCIAL_DOCUMENT_V2_CONTRACT_LIVE', default=True, cast=bool
)
